...
for i =  (numBOTO*split + 1):numBOTO
    ...
    label = predict(classifier, featuresaux);
    labels = [labels;"Boto"];
    predicted = [predicted; cell2mat(label(1))];
    if cell2mat(label(1)) == "Boto"
...
display("boto")
double(correctes)/double(totals) * 100
...
for i = (numDENT*split + 1):numDENT
    ...
    if cell2mat(label(1)) == "DentdeLleo"
       correctes = correctes + 1; 
       correctesT = correctesT + 1; 
    end
    totals = totals + 1;
...
for i = (numFRITLLARIA*split + 1):numFRITLLARIA
    ...
    predicted = [predicted; cell2mat(label(1))];
    if cell2mat(label(1)) == "Fritillaria"
       correctes = correctes + 1; 
       correctesT = correctesT + 1; 
    end
    totals = totals + 1;
...
for i = (numHEMEROCALLIS*split + 1):numHEMEROCALLIS
    ...
    if cell2mat(label(1)) == "Hemerocallis"
       correctes = correctes + 1; 
       correctesT = correctesT + 1; 
    end
    totals = totals + 1;
...
display("total")
double(correctesT)/double(totalsT) * 100
