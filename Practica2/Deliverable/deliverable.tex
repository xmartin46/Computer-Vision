...
\item \textbf{NAMEOFTHEFUNCTION}: function that gets the 3 main colors of the image using k-means and its presence percentage. It uses the \textbf{Mathwork: image2palette} utility which clusters pixels colors using k-means to make a palette.
